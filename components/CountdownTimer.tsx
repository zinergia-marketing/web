...
export default function CountdownTimer({ endDate, className = '' }: CountdownTimerProps) {
  ...
  return (
    <div className={`flex items-center justify-center gap-1 sm:gap-1.5 lg:gap-1 ${className}`}>
      <div className="flex flex-col items-center min-w-[40px] sm:min-w-[50px] lg:min-w-[45px]">
      ...
      <span className={`text-xl sm:text-2xl lg:text-xl font-bold ${isWhiteTheme ? 'text-white' : 'text-primary-purple'} -mx-0.5`}>:</span>
      <div className="flex flex-col items-center min-w-[40px] sm:min-w-[50px] lg:min-w-[45px]">
        <span className={`text-2xl sm:text-3xl lg:text-2xl font-bold ${isWhiteTheme ? 'text-white' : 'text-primary-purple'}`}>
